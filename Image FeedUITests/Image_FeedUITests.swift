...
class Image_FeedUITests: XCTestCase {
    ...
    func testAuth() throws {
        ...
        loginTextField.tap()
        loginTextField.typeText("btoporin@mail.ru")
        webView.swipeUp()
        ...
        passwordTextField.typeText("e716eco543re")
        passwordTextField.tap()
        webView.swipeUp()
    ...
    func testProfile() throws {
        ...
        XCTAssertTrue(app.staticTexts["Богдан"].exists)
        XCTAssertTrue(app.staticTexts["@bbbtp"].exists)
